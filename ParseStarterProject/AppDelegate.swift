...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let configuration = ParseClientConfiguration {
            ...
            $0.applicationId = "0c289607e7786233520946bea559533f6d417931"
            // Uncomment and add your clientKey (it's not required if you are using Parse Server):
            $0.clientKey = "06df1600a3765ad781b64fff6b4f9d93f6ee9815"
            
            // Uncomment the following line and change to your Parse Server address;
            $0.server = "http://ec2-54-90-249-35.compute-1.amazonaws.com:80/parse"
        ...
        // uncomment to create automatic users
